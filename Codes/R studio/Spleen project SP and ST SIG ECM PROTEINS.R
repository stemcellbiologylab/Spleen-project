...
data.pr.all = read.csv("F:/Proteomics/Data/Spleen project_SP/Excel sheets/14. Spleen project _TB and ST SIG UP_Secreted proteins.csv")
...
pheatmap(data.pr.log2.2, cluster_rows=F, show_rownames=T,scale='row',
         cluster_cols=T,main="all protein heatmap",annotation_col = df,color=colorRampPalette(c("#ff5252","#010203","#66b2b2"))(100)) 
dev.off()  
