...
data.pr.all = read.csv("F:/Proteomics/Data/Spleen project_SP/Excel sheets/13. Spleen project _ST SIG UP_Secreted proteins.csv")
...
write.table(diffexp.pr.all,file="ST SIG SECRETED UPREGULATED PROTEINS FOR PATHWAY.csv",sep=",")
