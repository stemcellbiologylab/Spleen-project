...
data.pr.all = read.csv("F:/Proteomics/Data/Spleen project_SP/Excel sheets/5. Spleen project _SP_Original.csv")
...
pheatmap(data.pr.log2.2, cluster_rows=T, show_rownames=F,scale='row',
