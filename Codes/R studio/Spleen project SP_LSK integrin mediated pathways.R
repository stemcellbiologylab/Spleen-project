...
#just performed to get names
de.pr.tb.st = read.csv("~/LSK vs ST INTEGRINS FOR PATHWAY NAMES.csv")
UniProt2Reactome = read.csv("F:/Proteomics/Data/Spleen project_SP/Data/Integrin and ECM interactome/LSK vs ST INTEGRINS FOR PATHWAY NAMES.csv")
...
write.table(enrich.path,file="LSK pathway names.csv",sep=",")
