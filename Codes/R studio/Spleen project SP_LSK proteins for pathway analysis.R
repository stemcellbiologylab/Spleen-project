...
data.pr.all = read.csv("F:/Proteomics/Data/Spleen project_SP/Excel sheets/11. Spleen project _LSK up wrt ST and TB.csv")
...
write.table(diffexp.pr.all,file="LSK ALL UP PROTEINS FOR PATHWAY.csv",sep=",")
